if (Parse == null) var Parse = require('parse/node').Parse;
...
var retrieveBusiness = function (successCb, failureCb, args) {
  ...
  console.log('Retrieving business for: ' + JSON.stringify(user) + '...');
...
var retrieveIntervalJSON = function (successCb, failureCb, args) {
  ...
  var retBusFailure = function (business, error) {
    console.log('INTERVAL RETRIEVE ERROR:'+error);
  }
...
var retrieveBeaconsJSON = function (successCb, failureCb, args) {
  ...
  var retBusFailure = function (business, error) {
    console.log('BEACON RETRIEVE ERROR:'+ error);
  }
